...
$sql = "SELECT email, id, full_name FROM users WHERE email = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("s", $user_email);

if (!$stmt->execute()) {
    die("SQL query execution failed");
}
...
if (isset($_SESSION['full_name'])) {
    ...
    $userFullName = "Guest"; // Default text when no user is logged in
}
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $new_first_name = $_POST["full_name"];
    $new_email = $_POST["email"];

    // Perform database update
    // Replace this with your actual database update code
    // For example, using PDO or MySQLi to update the user's profile in the database
...
<!-- Mirrored from themesbrand.com/velzon/html/default/pages-profile-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 15:45:19 GMT -->
<head>
        ...
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?php echo $userFullName; ?></span>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Welcome <?php echo $userFullName; ?>!</h6>
                            ...
                            <div class="card mt-n5">
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        ...
                                        <h5 class="fs-16 mb-1"><?php echo $userFullName; ?></h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3 d-flex">
                                        ...
                                        <input type="email" class="form-control" id="gitUsername" placeholder="Username" value="<?php echo $user_email; ?>">
                                    </div>
                                    <div class="mb-3 d-flex">
                                        <div class="avatar-xs d-block flex-shrink-0 me-3">
                                        ...
                                        <input type="text" class="form-control" id="websiteInput" placeholder="www.example.com" value="<?php echo $user_email; ?>">
                                    </div>
                                    <div class="mb-3 d-flex">
                                        <div class="avatar-xs d-block flex-shrink-0 me-3">
                                        ...
                                        <input type="text" class="form-control" id="dribbleName" placeholder="Username" value="<?php echo $user_email; ?>">
                                    </div>
                                    <div class="d-flex">
                                        <div class="avatar-xs d-block flex-shrink-0 me-3">
                                        ...
                                        <input type="text" class="form-control" id="pinterestName" placeholder="Username" value="<?php echo $userFullName; ?>">
                                    </div>
                                </div>
                            </div>
                            <!--end card-->
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="firstnameInput" placeholder="Enter your firstname" value="<?php echo $userFullName; ?>">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="lastnameInput" placeholder="Enter your lastname" value="nil">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="email" class="form-control" id="emailInput" placeholder="Enter your email" value="<?php echo $user_email; ?>">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-12">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="mb-3 pb-2">
                                                            ...
                                                            <textarea class="form-control" id="exampleFormControlTextarea" placeholder="Enter your description" rows="3">Hi I'm <?php echo $userFullName; ?>,It will be as simple as Occidental; in fact, it will be Occidental. To an English person, it will seem like simplified English, as a skeptical Cambridge friend of mine told me what Occidental is European languages are members of the same family.</textarea>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-12">

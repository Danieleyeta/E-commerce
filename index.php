                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <!--for the change of name of the account or the person that is login-->
                            <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">
    <?php echo $userFullName; ?>
</span><br>
<span id="contact-sales"><?php echo $user_email; ?></span>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="frontpage.php"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Profile</span></a>
                                ...
                                <div class="row mb-3 pb-1">
                                    <div class="col-12">
                                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                            <div class="flex-grow-1">
                                                <h4 class="fs-16 mb-1"><?php echo $greeting; ?>, <?php echo $userFullName; ?></h4>
...
<!--
        <div class="email">
            ...
            <p id="contact-sales">Your email is: <?php echo $user_email; ?></p>
            
        </div><br><br><br>
    
    <div class="container">
        <h1>Welcome to Dashboard</h1>
        <a  href="logout.php" class="btn btn-warning" id="log-out">Logout</a>
        <p id="contact-sales">Your email is: <?php echo $user_email; ?></p>
    </div>
                                                            -->
...
<!-- Mirrored from themesbrand.com/velzon/html/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 15:44:41 GMT -->
